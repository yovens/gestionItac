<?php
// eleve/mes_bulletins.php — style alternatif élève
...
// Récupération des notes via PDO
$stmt = $pdo->prepare("
    SELECT m.nom AS matiere, e.nom AS examen, n.note 
    FROM notes n
...
<div class="dashboard-container">
  ...
  <section class="panel-right">
    ...
    <?php if($count>0): ?>
      ...
      <?php endif; ?>
    <?php else: ?>
      <p class="warning">Aucune note disponible.</p>
    <?php endif; ?>
